...
using Goodreads.Application.Authors.Commands.DeleteAuhtor;
...
namespace Goodreads.API.Controllers
{
    ...
    public class AuthorsController(IMediator mediator) : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Application.Common.Responses.PagedResult<AuthorDto>), StatusCodes.Status200OK)]
