...
{
    public class ReviewAuthorClaimCommandHandler : IRequestHandler<ReviewAuthorClaimCommand, Result>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IUserContext _userContext;
        private readonly ILogger<ReviewAuthorClaimCommandHandler> _logger;
        public ReviewAuthorClaimCommandHandler(IUnitOfWork unitOfWork, IUserContext userContext, ILogger<ReviewAuthorClaimCommandHandler> logger)
        {
