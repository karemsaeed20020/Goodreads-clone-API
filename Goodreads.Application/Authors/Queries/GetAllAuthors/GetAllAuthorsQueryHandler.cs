...
{
    internal class GetAllAuthorsQueryHandler : IRequestHandler<GetAllAuthorsQuery, Common.Responses.PagedResult<AuthorDto>>
    {
        ...
        public async Task<Common.Responses.PagedResult<AuthorDto>> Handle(GetAllAuthorsQuery request, CancellationToken cancellationToken)
        {
            ...
            return Common.Responses.PagedResult<AuthorDto>.Create(dtoList, p.PageNumber, p.PageSize, count);
        }
    }
