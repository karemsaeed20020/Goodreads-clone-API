...
{
    public class GetReadingProgressesQueryHandler : IRequestHandler<GetReadingProgressesQuery, PagedResult<ReadingProgressDto>>
    {
        ...
        public async Task<PagedResult<ReadingProgressDto>> Handle(GetReadingProgressesQuery request, CancellationToken cancellationToken)
        {
            ...
            var result = await _unitOfWork.ReadingPrgresses.GetAllAsync(
