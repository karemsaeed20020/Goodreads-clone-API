...
{
    public class GetShelfByIdQueryHandler : IRequestHandler<GetShelfByIdQuery, Result<ShelfDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILogger<GetShelfByIdQueryHandler> _logger;
        private readonly IMapper _mapper;
        public GetShelfByIdQueryHandler(IUnitOfWork unitOfWork, ILogger<GetShelfByIdQueryHandler> logger, IMapper mapper)
        {
